...
public class Pool_ProjectileEnemy : MonoBehaviour
{
    public static Pool_ProjectileEnemy pool;
    public bool disableSpawnLimit = false;

    public Game_ProjectileEnemy prefabBullet;
    List<Game_ProjectileEnemy> listBullet = new List<Game_ProjectileEnemy>();
    ...
    {
        bulletQuantity = 0;
        foreach (Game_ProjectileEnemy x in listBullet)
        {
    ...
    /// <returns></returns>
    public Game_ProjectileEnemy SpawnBullet(float speed, float rotation, Vector3 position)
    {
        ...
        Game_ProjectileEnemy newBullet = Instantiate(prefabBullet);
    ...
    /// <returns></returns>
    public Game_ProjectileEnemy SpawnBullet(float speed, float rotation, Vector3 position, Vector3 target)
    {
